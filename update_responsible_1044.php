...
/**
 * Update all CRM items (entityTypeId 1044) to set the responsible person
 * to User ID 28.
 *
 * This script:
...
$progressFile = 'update_progress_1044.json';
...
echo "=== STEP 2: Updating assignedById to $newAssignedById ===\n\n";
